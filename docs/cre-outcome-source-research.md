...
As of the audit date, the ignored local warehouse contains 693 institutional multifamily rent-growth candidates across 27 source-defined markets and 30 consecutive quarters (2019-Q1 through 2026-Q2), plus 693 effective-rent rows and 431 physical-occupancy / 431 derived-vacancy rows across 25 source-defined markets for 2022-Q1 through 2026-Q2. A parser correction excluded 18 repeated table-heading rows that were not markets. The active corrected vintage contains 2,248 observations, complete source URLs, filing dates, units, sample counts, local snapshot hashes, no structural verification errors, no duplicate periods, and no unit or methodology inconsistencies within its 104 source-market-metric series.
