...
- AvalonBay's SEC-filed supplemental schedule includes a distinct quarterly same-store table for apartment homes, average monthly revenue per occupied home, and economic occupancy. It is a strong second-source candidate, but its methodology is not interchangeable with MAA's physical occupancy/effective-rent series: https://www.sec.gov/Archives/edgar/data/915912/000091591226000002/q42025ex-992.htm
...
As of the audit date, the ignored local warehouse contains 693 observations for each of twelve institutional multifamily outcomes: effective rent; reported YoY rent, revenue, operating-expense, and NOI growth; quarterly same-store revenue, operating expense, and NOI in disclosed USD thousands; exactly derived NOI margin; same-store apartment inventory; physical occupancy; and exactly derived vacancy. The active panel therefore contains 8,316 candidates across 27 source-defined markets and 30 quarters (2019-Q1 through 2026-Q2). A legacy-heading backfill added 262 occupancy and 262 vacancy observations from preserved SEC evidence. The same correction explicitly selects current-quarter rather than YTD occupancy in multi-period tables and rejects date/header rows by governed market-name shape. Apartment units are retained as `same_store_inventory`, not total metro inventory. Every filing passes an independent unit-count comparison between the rent and occupancy tables; every revenue, expense, NOI, and rent growth rate reconciles to its disclosed current and prior-year values within the governed rounding tolerance; and both current and prior periods satisfy revenue less operating expense equals NOI. The parser fails closed if the filing's dollars-in-thousands disclosure is absent. The active vintage has complete source URLs, filing dates, units, sample counts, local snapshot hashes, no structural verification errors, no duplicate periods, and no unit or methodology inconsistencies.

The second installed candidate source family is AvalonBay's SEC-filed quarterly same-store schedule. The ignored local evidence currently parses 2,291 candidate facts across 16 available quarters (2022-Q1 through 2026-Q1, with 2022-Q4 still missing from the preserved local series) and 32 distinct disclosed market labels. This count deliberately includes regional totals and source-label changes, not 32 stable metro definitions. A continuity artifact flags the missing quarter, market-universe changes, and four disclosed schema versions. Legacy rental-rate, later revenue-per-occupied-home, cash-basis, and rent-relief-adjusted measures remain separate and unapproved. AVB therefore adds valuable independent institutional evidence, but does not yet create a model-ready pooled rent target.
