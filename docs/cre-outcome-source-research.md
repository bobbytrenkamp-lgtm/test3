...
As of the audit date, the ignored local warehouse contains 693 observations for each of four institutional multifamily outcomes: effective rent, reported YoY rent growth, physical occupancy, and exactly derived vacancy. The active panel therefore contains 2,772 candidates across 27 source-defined markets and 30 quarters (2019-Q1 through 2026-Q2). A legacy-heading backfill added 262 occupancy and 262 vacancy observations from preserved SEC evidence. The same correction explicitly selects current-quarter rather than YTD occupancy in multi-period tables and rejects date/header rows by governed market-name shape. The active vintage has complete source URLs, filing dates, units, sample counts, local snapshot hashes, no structural verification errors, no duplicate periods, and no unit or methodology inconsistencies.
