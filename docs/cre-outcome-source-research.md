...
The next high-value independent source family is AvalonBay's SEC-filed quarterly same-store schedule, which discloses apartment homes, average monthly revenue per occupied home, and economic occupancy by region. It is not yet installed: its economic-occupancy and revenue methodology must remain separate from MAA physical occupancy/effective rent, and a dedicated source adapter plus longitudinal schema review is required before combining evidence.
