...
- Organization owns users, deals, documents, append-only document-purge events, extracted values, manual assumptions, review decisions, reconciliation runs, findings and audit events.
