...
| Required OM/rent-roll/operations/lease/debt extractions | Mostly proven | 57 governed scalars plus immutable worksheet/cell-backed rent-roll, operating account/period, lease schedule/options/rights and debt-term rows; category-scoped common header aliases, negative-boundary tests, derived approval, integrity and bounded downstream mappings | Corpus remains fictional and workbook limits remain explicit |
...
2. Continue testing bounded multi-sheet XLSX navigation with fictional workbooks; do not claim pixel-identical rendering.
