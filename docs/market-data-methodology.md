...
The same governed descriptive framework covers market rent, vacancy, renewal probability, downtime, tenant improvements, leasing commissions, expense/property-tax/insurance growth, exit cap rate, discount rate, debt interest rate, construction-cost growth, and lease-up pace. Benchmark matrices segment by metric, property type and geography. Correlations require exact date/geography/property matches and are labeled descriptive—not causal. Sources with incompatible definitions must remain separate rather than being pooled.
