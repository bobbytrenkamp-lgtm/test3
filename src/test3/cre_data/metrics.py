...
CRE_METRICS = {item.metric: item for item in (
    ...
    CREMetricSpec("average_monthly_revenue_per_occupied_home", ("multifamily",),
                  {"*": ("USD_per_unit_month",)}, "level", 0, None, .35,
                  ("same_store_revenue_per_occupied_home",),
                  "Source-defined monthly residential revenue per occupied home; not silently relabeled rent."),
    CREMetricSpec("average_monthly_revenue_growth_yoy", ("multifamily",),
                  {"*": ("decimal_fraction",)}, "signed_rate", -1, 3, .25,
                  ("same_store_revenue_per_occupied_home_yoy",),
                  "Year-over-year change in source-defined monthly revenue per occupied home."),
    CREMetricSpec("average_rental_rate", ("multifamily",), {"*": ("USD_per_unit_month",)},
                  "level", 0, None, .35, ("same_store_average_rental_rate",),
                  "Source-defined average rental rate; retained separately from revenue per occupied home."),
    CREMetricSpec("average_rental_rate_growth_yoy", ("multifamily",), {"*": ("decimal_fraction",)},
                  "signed_rate", -1, 3, .25, ("same_store_average_rental_rate_yoy",),
                  "Year-over-year change in source-defined average rental rate."),
    ...
    CREMetricSpec("revenue_growth_yoy", ("multifamily",), {"*": ("decimal_fraction",)}, "signed_rate", -1, 3, .25,
                  ("same_store_revenue_yoy",), "Source-reported same-store operating revenue growth year over year."),
    CREMetricSpec("revenue_growth_yoy_excluding_rent_relief", ("multifamily",),
                  {"*": ("decimal_fraction",)}, "signed_rate", -1, 3, .25,
                  ("same_store_revenue_yoy_excluding_rent_relief",),
                  "Source-reported same-store revenue growth excluding disclosed rent-relief effects; never silently pooled."),
    CREMetricSpec("revenue_growth_yoy_cash_basis", ("multifamily",),
                  {"*": ("decimal_fraction",)}, "signed_rate", -1, 3, .25,
                  ("same_store_revenue_yoy_cash_basis",),
                  "Source-reported same-store residential revenue growth with concessions on a cash basis."),
    CREMetricSpec("operating_expense_growth_yoy", ("multifamily",), {"*": ("decimal_fraction",)}, "signed_rate", -1, 3, .25,
                  ("same_store_operating_expense_yoy",), "Source-reported same-store operating expense growth year over year."),
    CREMetricSpec("noi_growth_yoy", ("multifamily",), {"*": ("decimal_fraction",)}, "signed_rate", -1, 3, .25,
                  ("same_store_noi_yoy",), "Source-reported same-store net operating income growth year over year."),
    _level("same_store_revenue", ("multifamily",), units=("USD_thousands_quarter",),
           methodologies=("same_store_operating_revenue",)),
    _level("same_store_operating_expense", ("multifamily",), units=("USD_thousands_quarter",),
           methodologies=("same_store_operating_expense",)),
    _level("same_store_noi", ("multifamily",), units=("USD_thousands_quarter",),
           methodologies=("same_store_net_operating_income",)),
    CREMetricSpec("noi_margin", ("multifamily",), {"*": ("decimal_fraction",)}, "rate", 0, 1, .15,
                  ("same_store_noi_margin",), "Derived same-store NOI divided by same-store operating revenue."),
    ...
    _rate("economic_vacancy_rate", ("multifamily",), methodologies=("economic_vacancy",)),
    ...
    CREMetricSpec("inventory", CORE_PROPERTY_TYPES,
                  {"multifamily": ("units",), "industrial": ("sf",), "office": ("sf",), "retail": ("sf",)},
                  "level", 0, None, .50, ("market_inventory", "same_store_inventory"),
                  "Market or explicitly source-defined same-store inventory at period end; universe is retained."),
