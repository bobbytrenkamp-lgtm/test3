...
CANDIDATES = (
    ...
    CRESourceCandidate("sec_maa_same_store", "MAA SEC quarterly supplemental schedules", "sec.gov", ("multifamily",),
        ("effective_rent", "rent_growth_yoy", "revenue_growth_yoy", "operating_expense_growth_yoy",
         "noi_growth_yoy", "same_store_revenue", "same_store_operating_expense", "same_store_noi",
         "noi_margin", "occupancy_rate", "vacancy_rate", "inventory"),
    ...
    CRESourceCandidate("sec_avb_same_store", "AvalonBay SEC quarterly supplemental schedules", "sec.gov", ("multifamily",),
        ("average_monthly_revenue_per_occupied_home", "economic_occupancy_rate", "residential_revenue_growth"),
        "source-defined operating regions", "quarterly", "issuer-dependent historical SEC exhibits",
        "official SEC filing", "permitted_with_SEC_fair_access", "numeric facts local; filing text not redistributed",
        "Cite issuer, accession, Exhibit 99.2, filing date, attachment, region row, and retrieval date.",
        "Economic occupancy and revenue per occupied home are distinct from MAA physical occupancy and effective rent; never harmonize silently.",
        "institutional_target", "issuer_specific_adapter_after_longitudinal_schema_review", (5,4,4,5,4,5,5,5,4)),
