...
FIELD_REGISTRY: tuple[FieldSpec, ...] = (
    ...
    _spec("market_rent", "Market rent", "decimal", r"(?i)market rent\s*[:$ ]+([0-9,.]+)", ("offering_memorandum", "appraisal"), unit="USD_per_area", currency="USD", export_target="marketLeasingProfiles.marketRent"),
    _spec("vacancy", "Vacancy", "rate", r"(?i)market vacancy\s*[: ]+([0-9.]+%?)", ("offering_memorandum", "appraisal"), unit="decimal_fraction", export_target="vacancy.generalVacancyRate"),
    _spec("renewal_probability", "Renewal probability", "rate", r"(?i)renewal probability\s*[: ]+([0-9.]+%?)", ("offering_memorandum", "appraisal"), unit="decimal_fraction", export_target="marketLeasingProfiles.renewalProbability"),
    _spec("downtime", "Downtime", "decimal", r"(?i)downtime\s*[: ]+([0-9.]+)", ("offering_memorandum", "appraisal"), unit="months", export_target="marketLeasingProfiles.downtimeMonths"),
    _spec("tenant_improvements", "Tenant improvements", "decimal", r"(?i)tenant improvements?\s*[:$ ]+([0-9,.]+)", ("offering_memorandum", "appraisal"), unit="USD_per_area", currency="USD", export_target="marketLeasingProfiles.tenantImprovements"),
    _spec("leasing_commissions", "Leasing commissions", "rate", r"(?i)leasing commissions?\s*[: ]+([0-9.]+%?)", ("offering_memorandum", "appraisal"), unit="decimal_fraction", export_target="marketLeasingProfiles.leasingCommissionRate"),
    _spec("expense_growth", "Expense growth", "signed_rate", r"(?i)expense growth\s*[: ]+([-0-9.]+%?)", ("offering_memorandum", "appraisal"), unit="decimal_fraction", export_target="growthCurves"),
    _spec("property_tax_growth", "Property tax growth", "signed_rate", r"(?i)property tax growth\s*[: ]+([-0-9.]+%?)", ("offering_memorandum", "appraisal"), unit="decimal_fraction", export_target="growthCurves"),
    _spec("insurance_growth", "Insurance growth", "signed_rate", r"(?i)insurance growth\s*[: ]+([-0-9.]+%?)", ("offering_memorandum", "appraisal"), unit="decimal_fraction", export_target="growthCurves"),
    _spec("exit_cap_rate", "Exit capitalization rate", "rate", r"(?i)exit cap(?:italization)? rate\s*[: ]+([0-9.]+%?)", ("offering_memorandum", "appraisal"), unit="decimal_fraction", export_target="valuation.terminalCapRate"),
    _spec("debt_interest_rate", "Debt interest rate", "rate", r"(?i)debt interest rate\s*[: ]+([0-9.]+%?)", DEBT, unit="decimal_fraction", export_target="debt.fixedRate"),
    _spec("construction_cost_growth", "Construction cost growth", "signed_rate", r"(?i)construction cost growth\s*[: ]+([-0-9.]+%?)", ("offering_memorandum", "appraisal"), unit="decimal_fraction", export_target="growthCurves"),
    _spec("lease_up_pace", "Lease-up pace", "decimal", r"(?i)lease[- ]up pace\s*[: ]+([0-9.]+)", ("offering_memorandum", "appraisal"), unit="units_per_month"),
)
