...
FIELD_REGISTRY: tuple[FieldSpec, ...] = (
    ...
    _spec("vacancy", "Vacancy", "rate", r"(?i)market vacancy\s*[: ]+([0-9.]+%?)", ("offering_memorandum", "appraisal"), unit="decimal_fraction", export_target="marketLeasingProfiles.vacancy"),
    ...
    _spec("exit_cap_rate", "Exit capitalization rate", "rate", r"(?i)exit cap(?:italization)? rate\s*[: ]+([0-9.]+%?)", ("offering_memorandum", "appraisal"), unit="decimal_fraction", export_target="valuation.exitCapRate"),
