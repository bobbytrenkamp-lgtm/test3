...
PERMISSIONS = {
    "viewer": {"read"},
    "analyst": {"read", "deal.create", "document.upload", "assumption.create", "opportunity.create", "opportunity.screen", "opportunity.archive", "opportunity.promote", "reconcile.run", "export.generate"},
